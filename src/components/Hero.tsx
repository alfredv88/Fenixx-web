  ...
  return (
    <section ref={containerRef} className="relative h-screen w-full overflow-hidden flex items-center">
      ...
      <motion.div
        ...
        style={{ y: monumentalY }}
        className="absolute bottom-12 left-0 w-full z-20 select-none pointer-events-none overflow-hidden flex justify-center"
      >
        <span className="text-monumental font-black text-white uppercase tracking-tighter whitespace-nowrap">
          IMPORT & EXPORT
        </span>
      </motion.div>
      ...
      <motion.div
        ...
        className="absolute inset-0 z-30 flex justify-end items-center pr-6 md:pr-12 lg:pr-24"
      >
        <div className="relative max-w-xl text-right">
          ...
          <motion.div
            ...
            className="absolute -right-6 md:-right-8 top-0 bottom-0 w-[2px] bg-gradient-to-b from-transparent via-[#FC3D03] to-transparent origin-top"
          />
          ...
          <motion.h1
            ...
            className="text-[50px] md:text-[60px] lg:text-[70px] font-bold tracking-tighter leading-[1.05] uppercase mb-1"
            style={{ color: '#ffffff' }}
          >
            Logística
          </motion.h1>
          ...
          <motion.h1
            ...
            className="text-[50px] md:text-[60px] lg:text-[70px] font-bold tracking-tighter leading-[1.05] uppercase mb-4"
            style={{ color: '#FC3D03' }}
          >
            integral
          </motion.h1>
          ...
          <motion.div
            ...
            className="mb-10"
          >
            <p className="text-base md:text-lg text-gray-300 font-medium max-w-lg ml-auto">
          ...
          >
            <a
              href="#servicios"
              className="bg-[#FC3D03] hover:bg-[#e33702] text-white px-10 py-5 rounded-full font-medium text-[16px] transition-all duration-300 hover:scale-105 active:scale-95 shadow-premium"
            >
              Saber más
            </a>
          </motion.div>
